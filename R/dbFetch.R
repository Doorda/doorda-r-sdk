...
#' @include utility_functions.R DoordaHostResult.R parse.response.R
...
#' @export
setMethod('dbFetch', c('DoordaHostResult', 'integer'), .fetch.with.count)

#' @rdname DoordaHostResult-class
#' @export
setMethod('dbFetch', c('DoordaHostResult', 'numeric'), .fetch.with.count)

#' @rdname DoordaHostResult-class
#' @export
setMethod('dbFetch', c('DoordaHostResult', 'missing'), .fetch.next.chunk)
